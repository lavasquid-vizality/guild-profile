...
const OtherIcon = (SVG, { ...args }) => {
  const SVGs = {
    ...
    CreatorMonetizableDisabled: [ 'M2.3701.3C1.2001.3.2701 1.23.2701 2.4S1.2001 4.5 2.3701 4.5C3.5401 4.5 4.4701 3.57 4.4701 2.4S3.5101.3 2.3701.3ZM2.3701.99C2.6101.99 2.8501 1.08 3.0601 1.2L1.1401 3.12C1.0501 2.91.9601 2.67.9601 2.4.9601 1.62 1.5901.99 2.3701.99ZM2.3701 3.81C2.1001 3.81 1.8601 3.72 1.6501 3.6L3.5701 1.68C3.6901 1.89 3.7801 2.13 3.7801 2.4 3.7501 3.18 3.1201 3.81 2.3701 3.81Z', 'PremiumChannelIcon', 'Add' ] // Blocked 0.3
  };
...
export const GuildFeatures = Object.freeze({
  ...
  CREATOR_MONETIZABLE_DISABLED: OtherIcon.bind(null, 'CreatorMonetizableDisabled'),
